...
if (isset($_POST['tombol_register'])) {
    ...
    // Jika return value adalah 1 (integer), berarti berhasil insert 1 baris
    if ($result === 1) {
        $_SESSION['pesan_message'] = "Registrasi berhasil! Silakan login";
        header("Location: login.php");
        exit;
    } else {
        // Jika return value string (pesan error)
        $error = $result;
    }
}
?>
