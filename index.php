...
$conn = new mysqli("localhost", "root", "", "simbs");
...
//PAGINATION SETTING
$jumlahDataPerHalaman = 3; // jumlah baris per halaman
    ...
    <main class="app-main">
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          <!--begin::Row-->
          <div class="row">
              <h1>Hallo, Selamat datang <?php echo $_SESSION ["username"] ?></h1>
              <div class="col-sm-6">
                ...
                <?php foreach ($buku as $data): ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="ubah_dataB.php?id=<?= $data['id_buku']; ?>" class="btn btn-success btn-sm">Edit</a>
                      <a href="hapus_dataB.php?id=<?= $data['id_buku']; ?>" class="btn btn-danger btn-sm"
