...
session_start();
//bagian tanda seru di sebelum isset dihilangkan
...
$error = "";
$success = isset($_SESSION['pesan_message']) ? $_SESSION['pesan_message'] : "";
unset($_SESSION['pesan_message']);
                ...
                <div class="login-card">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control" placeholder="Masukkan usernama..."
